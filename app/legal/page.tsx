const LegalPage = () => {
  return (
    <div>
      <section className="relative w-full h-auto mt-[30px] text-white">
        <div className="relative w-[90%] h-auto ml-[5%]">
          <div className="relative w-full h-auto flex flex-col items-center pt-[30px] border-t border-solid border-[#2D2D2F]">
            <div className="relative max-w-full lg:max-w-[1000px]">
              <div className="relative text-[15px]">
                <h2 className="text-[30px] font-bold lg:text-[60px] mb-[30px]">
                  Legal
                </h2>
                <p className="my-[15px]">
